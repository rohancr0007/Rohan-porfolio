...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailJs.send('service_iclk69q', 'template_lpxi2ss',{
      from_name: form.name,
      to_name: 'Rohan',
      from_email: form.email,
      to_email: 'rohansinghcr0007@gmail.com',
    ...
    <div className="xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 overflow-hidden">
      ...
      className="flex-[0.75] bg-black-100 p-8 rounded-2xl">
        ...
        className="mt-12 flex flex-col gap-8">
          ...
          <button type="submit" className="bg-tertiary py-3 px-8 outline-none w-fit text-white font-bold shadow-md shadow-primary rouded-xl">
